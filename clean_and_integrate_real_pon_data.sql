-- =====================================================
-- CLEAN AND INTEGRATE REAL PON DATA
-- FTTH Network Monitoring System
-- =====================================================
-- File: clean_and_integrate_real_pon_data.sql
...
-- =====================================================
-- 5. REBUILD PON_CONFIG FROM REAL DATA
-- =====================================================

-- Update OLT Central pon_config from real data
UPDATE ftth_items SET 
    pon_config = (
        SELECT JSON_OBJECT(
            'pons', JSON_ARRAYAGG(
        ...
        FROM olt_pons op
        WHERE op.item_id = ftth_items.id
    )
WHERE id = @olt_central_id AND @olt_central_id IS NOT NULL;

-- Update OLT North pon_config from real data
UPDATE ftth_items SET 
    pon_config = (
        SELECT JSON_OBJECT(
            'pons', JSON_ARRAYAGG(
...
SELECT 'Real PON-ODC Integration Complete' as status;
...
-- =====================================================
-- END OF CLEAN AND INTEGRATE SCRIPT
-- =====================================================
