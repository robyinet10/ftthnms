...
-- 
-- IMPORTANT FOREIGN KEY CONSTRAINTS:
-- - ont_connected_odp_id: Links ONT/HTB items to ODP items (self-referencing)
-- - odp_parent_odc_id: Links ODP items to ODC parent items (self-referencing)
-- - auto_generated_by_route_id: Links auto-generated items to cable routes
-- - All foreign keys use ON DELETE SET NULL for flexible item management
-- =====================================================
...
CREATE TABLE ftth_items (
    ...
    odp_splitter_ratio VARCHAR(10) DEFAULT '1:8' COMMENT 'ODP splitter ratio',
    ...
    ont_customer_name VARCHAR(255) NULL COMMENT 'ONT Customer name (specific for ONT/HTB)',
    ont_customer_address TEXT NULL COMMENT 'ONT Customer address (specific for ONT/HTB)',
    ...
    ont_service_plan VARCHAR(100) NULL COMMENT 'Internet service plan for ONT/HTB',
    ont_connection_status ENUM('connected','disconnected','suspended','maintenance') DEFAULT 'connected' COMMENT 'ONT specific connection status',
...
-- Sample data telah dihapus untuk production environment
-- Data dummy tidak diperlukan untuk deployment yang bersih
...
-- Note: Foreign key constraints with ON DELETE SET NULL ensure referential integrity
-- while allowing parent items to be deleted without affecting child items
